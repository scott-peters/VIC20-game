...
JDA symbolic consts for the note values would make this more readable, and
JDA I'd also break it up so that each note/note/note/duration was on a
JDA separate line so you can see the groupings better - changing this would
JDA be a pain

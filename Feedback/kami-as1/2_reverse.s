...
GETINPUT:
			JDA which routine?  make this a symbolic constant
			jsr 	$ffcf		; Call Kernal routine
			cmp 	#13			; Compare to carriage return
			beq		.RETURN
			sta 	STRING,y
			iny
			JDA bug: should be cpy
			cmp 	#50
			JDA why not restructure as bne and fall through onto rts?
...
JDA should document that this is common to two distinct subroutines
.RETURN		rts
